...
## Aeroplane surface model

As part of the surfacing module, a full aircraft body was designed using CATIA's Generative Shape Design workbench — demonstrating complex surface modelling including fuselage, wings, tail, and engine nacelles.
...
> Performed FEA-based structural analysis of an engine piston in CATIA V5, comparing Aluminum Alloy vs Aluminum Graphite under cyclic load — determined Von Mises stress of 3.25×10⁴ N/m² confirming design safety
